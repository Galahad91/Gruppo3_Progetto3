...
public class AILerp : VersionedMonoBehaviour 
{
	...
	{   
		...
		//target = GameObject.FindGameObjectWithTag ("Torre").transform;
	...
	{
		//gameObject.GetComponent<Assassin> ().GetPriorita ();

		/*if (gameObject.GetComponent<Characters> ().currentSteps >= 0) 
		{
			Debug.Log (gameObject.GetComponent<Characters> ().currentSteps);
			gameObject.GetComponent<Characters> ().currentSteps--;
